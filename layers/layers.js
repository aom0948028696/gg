...
lyr_GoogleSatellite_0.setVisible(true);lyr_amphoe_1.setVisible(true);lyr_village_2.setVisible(true);lyr_water_way_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_amphoe_1,lyr_village_2,lyr_water_way_3];
